...
class CarClassC_AdapterDelegateGLM(

    val onItemClick: (item: ClickCarItem) -> Unit
) :
    AbsListItemAdapterDelegate<Cars.C_class, Cars, CarClassC_AdapterDelegateGLM.CarClassCHolderGLM>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): CarClassCHolderGLM {
        return CarClassCHolderGLM(parent.inflate(R.layout.car_class_c_glm), onItemClick)
    }
