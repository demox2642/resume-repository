...
class CarClassB_AdapterDelegateSGLM(

    val onItemClick: (item: ClickCarItem) -> Unit
) :
    AbsListItemAdapterDelegate<Cars.B_class, Cars, CarClassB_AdapterDelegateSGLM.CarClassBHolderGLM>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): CarClassBHolderGLM {
        return CarClassBHolderGLM(parent.inflate(R.layout.car_class_b_sglm), onItemClick)
    }
