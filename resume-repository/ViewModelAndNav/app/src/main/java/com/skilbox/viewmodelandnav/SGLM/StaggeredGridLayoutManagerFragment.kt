...
import com.skilbox.viewmodelapp.Adapter.CarAdapterSGLM
...
class StaggeredGridLayoutManagerFragment : Fragment(R.layout.fragment_staggered_grid_layout_manager) {

    private var carAdapter: CarAdapterSGLM? = null
    ...
    private fun initList() {
        carAdapter = CarAdapterSGLM { ClickCarItem -> clickHandler(ClickCarItem) }
    ...
    private fun detailInfo(id: Long, carImage: String, carBrend: String, carName: String, carEngine_capacity: String) {
        ...
        val action = StaggeredGridLayoutManagerFragmentDirections.actionSGLMFragmentToDetailFragmentSGLM(id, carImage, carBrend, carName, carEngine_capacity)
    ...
    private fun showDialogForAddCar(carClass: String) {
        val args = StaggeredGridLayoutManagerFragmentDirections.actionSGLMFragmentToCarClassDialogFragmentSGLM(carClass = carClass)
