...
class CarClassD_AdapterDelegateGLM(

    val onItemClick: (item: ClickCarItem) -> Unit
) : AbsListItemAdapterDelegate<Cars.D_class, Cars, CarClassD_AdapterDelegateGLM.CarClassDHolderGLM>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): CarClassDHolderGLM {
        return CarClassDHolderGLM(parent.inflate(R.layout.car_class_d_glm), onItemClick)
    }
