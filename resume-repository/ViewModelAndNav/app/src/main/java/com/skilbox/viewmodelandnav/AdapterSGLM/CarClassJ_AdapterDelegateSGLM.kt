...
class CarClassJ_AdapterDelegateSGLM(

    val onItemClick: (item: ClickCarItem) -> Unit
) :
    AbsListItemAdapterDelegate<Cars.J_class, Cars, CarClassJ_AdapterDelegateSGLM.CarClassJHolderGLM>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): CarClassJHolderGLM {
        return CarClassJHolderGLM(parent.inflate(R.layout.car_class_j_sglm), onItemClick)
    }
