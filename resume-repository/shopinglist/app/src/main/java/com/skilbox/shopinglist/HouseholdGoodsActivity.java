...
public class HouseholdGoodsActivity extends AppCompatActivity {
    ...
    public void addHouseholdGoods(View view) {
        EditText editText = findViewById(R.id.edit_text_products);
        String stringitem = editText.getText().toString();
        if (stringitem.equals("")){
            Toast toast = Toast.makeText(this,"Введите наименование товара",Toast.LENGTH_SHORT);
    ...
    public void deleteHouseholdGoods(View view) {
